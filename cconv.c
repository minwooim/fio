				  ...
				  size_t top_sz)
{
	...
	o->iodepth_min = le32_to_cpu(top->iodepth_min);
	o->iodepth_period = le32_to_cpu(top->iodepth_period);
				   ...
				   struct thread_options *o)
{
	...
	top->iodepth_min = cpu_to_le32(o->iodepth_min);
	top->iodepth_period = cpu_to_le32(o->iodepth_period);
