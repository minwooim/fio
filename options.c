...
struct fio_option fio_options[FIO_MAX_OPTS] = {
	...
	},
	{
		...
		.help	= "Policy for verifying writes",
		.def	= "default",
		.posval = {
			  { .ival = "default",
			    .oval = VERIFY_POLICY_DEFAULT,
			    .help = "Verify all writes",
			  },
			  { .ival = "flush",
			    .oval = VERIFY_POLICY_FLUSH,
			    .help = "Only verify writes that have been flushed",
			  },
		},
		.category = FIO_OPT_C_IO,
		.group	= FIO_OPT_G_VERIFY,
